...
Mean by Max: Calculated as mean_expr / max_umi, where:
mean_expr is the total UMI count divided by the number of genes with non-zero expression levels.
max_umi is the maximum expression level across all genes.
