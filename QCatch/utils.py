...
from QCatch.input_processing import load_json_txt_file
    ...
    def __init__(self, input_str: str):
        ...
        if self.provided.is_file():
            ...
            if os.path.exists(h5ad_file_path):
                ...
                self.mtx_data = load_fry(mtx_dir_path, output_format="raw")
                ...
                (
                    ...
                    self.permit_list_json_data,
                    self.feature_dump_data,
                ) = load_json_txt_file(quant_out_dir, used_simpleaf)

                # detect usa_mode
                self.usa_mode = quant_json_data["usa_mode"]
